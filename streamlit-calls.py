...
def main():
    ...
    # File upload option (kept), or fallback to a repo-committed file
    uploaded_file = st.file_uploader("Upload Excel file", type=['xlsx'])

    if uploaded_file is not None:
        file_path = uploaded_file  # Streamlit UploadedFile works directly with pandas
    else:
        file_path = 'datatest.xlsx'  # ensure this exists in repo root or adjust path
